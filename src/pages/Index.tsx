      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 pt-16 pb-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h1 className="text-5xl md:text-7xl font-luckiest text-primary mb-4 leading-tight">
              EVERY CAR DESERVES A FUN LICENSE PLATE.
            </h1>
            <h2 className="text-2xl md:text-3xl font-luckiest text-red-600 mb-8">
              FIND YOURS HERE
            </h2>
        ...
        <div className="container mx-auto px-4 pb-16">
          ...
          {filteredPlates.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-luckiest text-primary mb-2">No plates found</h3>
